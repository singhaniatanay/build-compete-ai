              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-sm font-medium">AI Image Classification Solution</p>
                ...
                <div key={i} className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-sm font-medium">
                      {["Natural Language Processor", "Image Recognition API", "Recommendation Engine", "Chat Sentiment Analysis", "Predictive Analytics Tool"][i-1]}
                    </p>
